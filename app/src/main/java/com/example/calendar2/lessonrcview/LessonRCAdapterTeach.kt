...
import com.example.calendar2.fragments.DayFragmentTeacher

class LessonRCAdapterTeach(dayFragmentTeacher: DayFragmentTeacher) : RecyclerView.Adapter<LessonRCAdapterTeach.LessonHolder>() {
